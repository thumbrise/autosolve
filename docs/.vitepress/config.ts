      ...
      '/internals/': [
        {
          ...
          items: [
            ...
            {text: 'resilience Package', collapsed: false, items: [
              {text: 'Overview', link: '/internals/resilience/'},
              {text: 'Options & Plugins', link: '/internals/resilience/options-plugins'},
              {text: 'Retry', link: '/internals/resilience/retry'},
              {text: 'Backoff', link: '/internals/resilience/backoff'},
              {text: 'Observability (OTEL)', link: '/internals/resilience/otel'},
              {text: 'Vision', link: '/internals/resilience/vision'},
            ]},
            {text: 'longrun (deprecated)', collapsed: true, items: [
              {text: 'Overview', link: '/internals/longrun/'},
            ]},
          ],
        },
      ],
      ...
      '/devlog/': [
        {
          ...
          items: [
            ...
            {text: '#13 — Killing longrun', link: '/devlog/013-killing-longrun'},
          ],
        },
      ],
      '/project/': [
