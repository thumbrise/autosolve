...
export default defineConfig({
  ...
  head: [
    ['meta', { name: 'keywords', content: 'github issue automation self-hosted, golang long running service retry, golang graceful degraded mode, opentelemetry golang worker metrics' }],
  ],
