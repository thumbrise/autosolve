      ...
      '/internals/': [
        {
          ...
          items: [
            ...
            {text: 'longrun: Failure Pipeline', link: '/internals/longrun-pipeline'},
            {text: 'longrun: Backoff & State', link: '/internals/longrun-backoff'},
            {text: 'longrun: Observability', link: '/internals/longrun-observability'},
          ],
        },
      ],
      '/contributing/': [
